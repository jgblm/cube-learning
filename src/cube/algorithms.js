...
export const PLL_COMMON = [
  { id: 'pll-ua', name: { zh: 'Ua 公式', en: 'Ua perm' }, algorithm: "R U R' U R U2 R' U R U' R' U'" },
  { id: 'pll-ub', name: { zh: 'Ub 公式', en: 'Ub perm' }, algorithm: "R' U' R U' R' U2 R U' R' U R U" },
  { id: 'pll-h', name: { zh: 'H 公式', en: 'H perm' }, algorithm: "M2 U M2 U2 M2 U M2" },
  { id: 'pll-z', name: { zh: 'Z 公式', en: 'Z perm' }, algorithm: "M2 U M2 U M' U2 M2 U2 M' U2" },
  { id: 'pll-aa', name: { zh: 'Aa 公式', en: 'Aa perm' }, algorithm: "R' F R' B2 R F' R' B2 R2" },
  { id: 'pll-ab', name: { zh: 'Ab 公式', en: 'Ab perm' }, algorithm: "R2 B2 R F R' B2 R F' R2" },
  { id: 'pll-t', name: { zh: 'T 公式', en: 'T perm' }, algorithm: "R U R' U R' F R2 U' R' U' R U R' F'" },
  { id: 'pll-ja', name: { zh: 'Ja 公式', en: 'Ja perm' }, algorithm: "R' U L' U2 R U' R' U2 R L" },
  { id: 'pll-jb', name: { zh: 'Jb 公式', en: 'Jb perm' }, algorithm: "R U R' F' R U R' U' R' F R2 U' R' U'" },
  { id: 'pll-f', name: { zh: 'F 公式', en: 'F perm' }, algorithm: "R' U' F R U R' U' R' F' R U R' U' R' U R U R'" },
  { id: 'pll-na', name: { zh: 'Na 公式', en: 'Na perm' }, algorithm: "R U R' U R U R' F' R U R' U' R' F R2 U' R' U'" },
  { id: 'pll-nb', name: { zh: 'Nb 公式', en: 'Nb perm' }, algorithm: "R' U L' U2 R U' R' U2 R L" },
  { id: 'pll-ra', name: { zh: 'Ra 公式', en: 'Ra perm' }, algorithm: "R U R' F' R U R' U' R' F R2 U' R' U'" },
  { id: 'pll-rb', name: { zh: 'Rb 公式', en: 'Rb perm' }, algorithm: "R' U' R U R' F' R U R' U' R' F R2" },
  { id: 'pll-v', name: { zh: 'V 公式', en: 'V perm' }, algorithm: "R' U R' U' R' F' R F R' U' R' U' R U R'" },
  { id: 'pll-y', name: { zh: 'Y 公式', en: 'Y perm' }, algorithm: "F R U' R' U' R U R' F' R U R' U' R' F R F'" },
  { id: 'pll-ga', name: { zh: 'Ga 公式', en: 'Ga perm' }, algorithm: "R' U' R U D' R2 U R' U R2 D R2 U' R' U' R" },
];
